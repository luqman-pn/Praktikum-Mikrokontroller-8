  ...
  while(!exitProgram)
  {
    do
    {
      ...
      switch(command)
      {
        ...
        exitProgram=1;
        break;
        default : Serial.println("Wrong command, please type command again!");
        break;
      }
    }
    while(command=0);
...
void writeEEPROM()
{
  ...
  do
  {
    ...
    if(address>512)
    {
      Serial.println("Address maximal id 512, please type again!");
    }
  }
  while(address>512);
  int data;
...
void readEEPROM()
{
  ...
  do
  {
    ...
    if(address>512)
    {
      Serial.println("Address maximal is 512, please tye again!");
    }
  }
  while(address>512);
